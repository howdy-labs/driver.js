...
var getStyleProperty = function getStyleProperty(element, propertyName) {
  ...
  var doc = arguments.length > 3 ? arguments[3] : undefined;
  ...
  _createClass(Element, [{
    ...
    value: function fixStackingContext() {
      ...
      while (parentNode) {
        ...
        var transform = Object(_common_utils__WEBPACK_IMPORTED_MODULE_1__["getStyleProperty"])(parentNode, 'transform', true, this.document);

        var transformStyle = Object(_common_utils__WEBPACK_IMPORTED_MODULE_1__["getStyleProperty"])(parentNode, 'transform-style', true, this.document);

        var transformBox = Object(_common_utils__WEBPACK_IMPORTED_MODULE_1__["getStyleProperty"])(parentNode, 'transform-box', true, this.document);

        var filter = Object(_common_utils__WEBPACK_IMPORTED_MODULE_1__["getStyleProperty"])(parentNode, 'filter', true, this.document);

        var perspective = Object(_common_utils__WEBPACK_IMPORTED_MODULE_1__["getStyleProperty"])(parentNode, 'perspective', true, this.document); // Stacking context gets disturbed if
        // - Parent has z-index
        // - Opacity is below 0
