...
/*!*********************************!*\
  !*** ./src/common/constants.js ***!
  \*********************************/
/*! exports provided: OVERLAY_OPACITY, OVERLAY_PADDING, SHOULD_ANIMATE_OVERLAY, SHOULD_OUTSIDE_CLICK_CLOSE, ALLOW_KEYBOARD_CONTROL, SHOULD_OUTSIDE_CLICK_NEXT, ESC_KEY_CODE, LEFT_KEY_CODE, RIGHT_KEY_CODE, ID_OVERLAY, ID_STAGE, ID_POPOVER, CLASS_DRIVER_HIGHLIGHTED_ELEMENT, CLASS_POSITION_RELATIVE, CLASS_FIX_STACKING_CONTEXT, CLASS_STAGE_NO_ANIMATION, CLASS_POPOVER_TIP, CLASS_POPOVER_TITLE, CLASS_POPOVER_DESCRIPTION, CLASS_POPOVER_FOOTER, CLASS_CLOSE_BTN, CLASS_NEXT_STEP_BTN, CLASS_PREV_STEP_BTN, CLASS_BTN_DISABLED, CLASS_CLOSE_ONLY_BTN, CLASS_NAVIGATION_BTNS, ANIMATION_DURATION_MS, POPOVER_HTML, OVERLAY_HTML, STAGE_HTML */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CLASS_POPOVER_TITLE", function() { return CLASS_POPOVER_TITLE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CLASS_POPOVER_DESCRIPTION", function() { return CLASS_POPOVER_DESCRIPTION; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CLASS_CLOSE_ONLY_BTN", function() { return CLASS_CLOSE_ONLY_BTN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CLASS_NAVIGATION_BTNS", function() { return CLASS_NAVIGATION_BTNS; });
 ...
 */
var createNodeFromString = function createNodeFromString(htmlString, doc) {
...
var getStyleProperty = function getStyleProperty(element, propertyName, doc) {
  var prefixVendor = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  ...
  if (element.currentStyle) {
    ...
    propertyValue = doc.defaultView.getComputedStyle(element, null).getPropertyValue(propertyName);
  }
...
/* harmony import */ var _position__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./position */ "./src/core/position.js");
...
var Element = /*#__PURE__*/function () {
  ...
  _createClass(Element, [{
    ...
    value: function getCalculatedPosition() {
      ...
      var scrollLeft = this.window.pageXOffset || documentElement.scrollLeft || body.scrollLeft;
      var elementRect = this.node.getBoundingClientRect();
    ...
    value: function fixStackingContext() {
      ...
      while (parentNode) {
        ...
        var zIndex = Object(_common_utils__WEBPACK_IMPORTED_MODULE_1__["getStyleProperty"])(parentNode, 'z-index', this.document);

        var opacity = parseFloat(Object(_common_utils__WEBPACK_IMPORTED_MODULE_1__["getStyleProperty"])(parentNode, 'opacity'), this.document);

        var transform = Object(_common_utils__WEBPACK_IMPORTED_MODULE_1__["getStyleProperty"])(parentNode, 'transform', this.document, true);

        var transformStyle = Object(_common_utils__WEBPACK_IMPORTED_MODULE_1__["getStyleProperty"])(parentNode, 'transform-style', this.document, true);

        var transformBox = Object(_common_utils__WEBPACK_IMPORTED_MODULE_1__["getStyleProperty"])(parentNode, 'transform-box', this.document, true);

        var filter = Object(_common_utils__WEBPACK_IMPORTED_MODULE_1__["getStyleProperty"])(parentNode, 'filter', this.document, true);

        var perspective = Object(_common_utils__WEBPACK_IMPORTED_MODULE_1__["getStyleProperty"])(parentNode, 'perspective', this.document, true); // Stacking context gets disturbed if
        // - Parent has z-index
        // - Opacity is below 0
    ...
    value: function getStyleProperty(property) {
      return Object(_common_utils__WEBPACK_IMPORTED_MODULE_1__["getStyleProperty"])(this.node, property, this.document);
    }
    /**
...
var Overlay = /*#__PURE__*/function () {
   ...
   * @param {Document} document
   */
  function Overlay(options, win, doc) {
  ...
  _createClass(Overlay, [{
    ...
    value: function attachNode() {
      ...
      if (!pageOverlay) {
        pageOverlay = Object(_common_utils__WEBPACK_IMPORTED_MODULE_1__["createNodeFromString"])(_common_constants__WEBPACK_IMPORTED_MODULE_0__["OVERLAY_HTML"], this.document);
...
/* harmony import */ var _element__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./element */ "./src/core/element.js");
/* harmony import */ var _common_constants__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../common/constants */ "./src/common/constants.js");
...
var Popover = /*#__PURE__*/function (_Element) {
   ...
   * @param {Document} document
   */
  function Popover(options, win, doc) {
    var _this;
  ...
  _createClass(Popover, [{
    key: "attachNode",
    value: function attachNode() {
      var popover = this.document.getElementById(_common_constants__WEBPACK_IMPORTED_MODULE_12__["ID_POPOVER"]);

      if (popover) {
        popover.parentElement.removeChild(popover);
      }

      popover = Object(_common_utils__WEBPACK_IMPORTED_MODULE_13__["createNodeFromString"])(Object(_common_constants__WEBPACK_IMPORTED_MODULE_12__["POPOVER_HTML"])(this.options.className), this.document);
      this.document.body.appendChild(popover);
      this.node = popover;
      this.tipNode = popover.querySelector(".".concat(_common_constants__WEBPACK_IMPORTED_MODULE_12__["CLASS_POPOVER_TIP"]));
      this.titleNode = popover.querySelector(".".concat(_common_constants__WEBPACK_IMPORTED_MODULE_12__["CLASS_POPOVER_TITLE"]));
      this.descriptionNode = popover.querySelector(".".concat(_common_constants__WEBPACK_IMPORTED_MODULE_12__["CLASS_POPOVER_DESCRIPTION"]));
      this.footerNode = popover.querySelector(".".concat(_common_constants__WEBPACK_IMPORTED_MODULE_12__["CLASS_POPOVER_FOOTER"]));
      this.nextBtnNode = popover.querySelector(".".concat(_common_constants__WEBPACK_IMPORTED_MODULE_12__["CLASS_NEXT_STEP_BTN"]));
      this.prevBtnNode = popover.querySelector(".".concat(_common_constants__WEBPACK_IMPORTED_MODULE_12__["CLASS_PREV_STEP_BTN"]));
      this.closeBtnNode = popover.querySelector(".".concat(_common_constants__WEBPACK_IMPORTED_MODULE_12__["CLASS_CLOSE_BTN"]));
    }
    /**
    ...
    value: function setInitialState() {
      ...
      this.node.querySelector(".".concat(_common_constants__WEBPACK_IMPORTED_MODULE_12__["CLASS_POPOVER_TIP"])).className = _common_constants__WEBPACK_IMPORTED_MODULE_12__["CLASS_POPOVER_TIP"];
    }
    /**
    ...
    value: function renderFooter() {
      ...
      if (!hasSteps) {
        ...
        this.closeBtnNode.classList.add(_common_constants__WEBPACK_IMPORTED_MODULE_12__["CLASS_CLOSE_ONLY_BTN"]);
      } else {
        // @todo modify CSS to use block
        this.nextBtnNode.style.display = 'inline-block';
        this.prevBtnNode.style.display = 'inline-block';
        this.closeBtnNode.classList.remove(_common_constants__WEBPACK_IMPORTED_MODULE_12__["CLASS_CLOSE_ONLY_BTN"]);
      }

      this.footerNode.style.display = 'block';

      if (this.options.isFirst) {
        this.prevBtnNode.classList.add(_common_constants__WEBPACK_IMPORTED_MODULE_12__["CLASS_BTN_DISABLED"]);
        this.nextBtnNode.innerHTML = this.options.startBtnText;
      } else {
        this.prevBtnNode.classList.remove(_common_constants__WEBPACK_IMPORTED_MODULE_12__["CLASS_BTN_DISABLED"]);
      }
  ...
  return Popover;
}(_element__WEBPACK_IMPORTED_MODULE_11__["default"]);
...
/* harmony import */ var _element__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./element */ "./src/core/element.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var Stage = /*#__PURE__*/function (_Element) {
   ...
   * @param {Document} document
   */
  function Stage(options, win, doc) {
    var _this;
  ...
  _createClass(Stage, [{
    key: "attachNode",
    value: function attachNode() {
      var stage = this.document.getElementById(_common_constants__WEBPACK_IMPORTED_MODULE_7__["ID_STAGE"]);

      if (!stage) {
        stage = Object(_common_utils__WEBPACK_IMPORTED_MODULE_8__["createNodeFromString"])(_common_constants__WEBPACK_IMPORTED_MODULE_7__["STAGE_HTML"], this.document);
      ...
      if (!this.options.animate) {
        this.node.classList.add(_common_constants__WEBPACK_IMPORTED_MODULE_7__["CLASS_STAGE_NO_ANIMATION"]);
      } else {
        this.node.classList.remove(_common_constants__WEBPACK_IMPORTED_MODULE_7__["CLASS_STAGE_NO_ANIMATION"]);
      }
    }
    /**
  ...
  return Stage;
}(_element__WEBPACK_IMPORTED_MODULE_9__["default"]);
...
/* harmony import */ var _core_overlay__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./core/overlay */ "./src/core/overlay.js");
/* harmony import */ var _core_element__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./core/element */ "./src/core/element.js");
/* harmony import */ var _core_popover__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./core/popover */ "./src/core/popover.js");
/* harmony import */ var _common_constants__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./common/constants */ "./src/common/constants.js");
/* harmony import */ var _core_stage__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./core/stage */ "./src/core/stage.js");
...
var Driver = /*#__PURE__*/function () {
  ...
  function Driver() {
    ...
    this.options = _objectSpread({
      animate: _common_constants__WEBPACK_IMPORTED_MODULE_8__["SHOULD_ANIMATE_OVERLAY"],
      // Whether to animate or not
      opacity: _common_constants__WEBPACK_IMPORTED_MODULE_8__["OVERLAY_OPACITY"],
      // Overlay opacity
      padding: _common_constants__WEBPACK_IMPORTED_MODULE_8__["OVERLAY_PADDING"],
      // Spacing around the element from the overlay
      scrollIntoViewOptions: null,
      // Options to be passed to `scrollIntoView`
      allowClose: _common_constants__WEBPACK_IMPORTED_MODULE_8__["SHOULD_OUTSIDE_CLICK_CLOSE"],
      // Whether to close overlay on click outside the element
      keyboardControl: _common_constants__WEBPACK_IMPORTED_MODULE_8__["ALLOW_KEYBOARD_CONTROL"],
      // Whether to allow controlling through keyboard or not
      overlayClickNext: _common_constants__WEBPACK_IMPORTED_MODULE_8__["SHOULD_OUTSIDE_CLICK_NEXT"],
    ...
    this.overlay = new _core_overlay__WEBPACK_IMPORTED_MODULE_5__["default"](this.options, this.window, this.document);
  ...
  _createClass(Driver, [{
    ...
    value: function onClick(e) {
      ...
      var popover = this.document.getElementById(_common_constants__WEBPACK_IMPORTED_MODULE_8__["ID_POPOVER"]);
      ...
      var nextClicked = e.target.classList.contains(_common_constants__WEBPACK_IMPORTED_MODULE_8__["CLASS_NEXT_STEP_BTN"]);
      var prevClicked = e.target.classList.contains(_common_constants__WEBPACK_IMPORTED_MODULE_8__["CLASS_PREV_STEP_BTN"]);
      var closeClicked = e.target.classList.contains(_common_constants__WEBPACK_IMPORTED_MODULE_8__["CLASS_CLOSE_BTN"]);
    ...
    value: function onKeyUp(event) {
      ...
      if (event.keyCode === _common_constants__WEBPACK_IMPORTED_MODULE_8__["ESC_KEY_CODE"]) {
        this.reset();
        return;
      ...
      if (event.keyCode === _common_constants__WEBPACK_IMPORTED_MODULE_8__["RIGHT_KEY_CODE"]) {
        this.handleNext();
      } else if (event.keyCode === _common_constants__WEBPACK_IMPORTED_MODULE_8__["LEFT_KEY_CODE"]) {
        this.handlePrevious();
      }
    }
    /**
    ...
    value: function prepareElementFromStep(currentStep) {
      ...
      var isStepDefinition = typeof currentStep !== 'string' && !Object(_common_utils__WEBPACK_IMPORTED_MODULE_10__["isDomElement"])(currentStep);
      ...
      if (isStepDefinition) {
        ...
        elementOptions = _objectSpread(_objectSpread({}, this.options), currentStep);
      } // If the given element is a query selector or a DOM element?


      var domElement = Object(_common_utils__WEBPACK_IMPORTED_MODULE_10__["isDomElement"])(querySelector) ? querySelector : this.document.querySelector(querySelector);
      ...
      if (elementOptions.popover && elementOptions.popover.title) {
        ...
        var popoverOptions = _objectSpread(_objectSpread(_objectSpread({}, elementOptions), elementOptions.popover), {}, {
        ...
        popover = new _core_popover__WEBPACK_IMPORTED_MODULE_7__["default"](popoverOptions, this.window, this.document);
      }

      var stageOptions = _objectSpread({}, elementOptions);

      var stage = new _core_stage__WEBPACK_IMPORTED_MODULE_9__["default"](stageOptions, this.window, this.document);
      return new _core_element__WEBPACK_IMPORTED_MODULE_6__["default"]({
        node: domElement,
...
/***/ 0:
/*!**********************************************!*\
  !*** multi ./src/driver.scss ./src/index.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./src/driver.scss */"./src/driver.scss");
